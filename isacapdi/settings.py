"""
Django settings for isacapdi project.
...
SECRET_KEY = "django-insecure-^4!qpir#(x3w^ztg^-!7*f#kwsz4f6gb@cm7mz=@bf46%mu!^h"
...
WSGI_APPLICATION = "isacapdi.wsgi.application"
